...
static int sh_audio_is_dts(sh_audio_t *sh)
{
    return sh->gsh->codec && strcmp(sh->gsh->codec, "dts") == 0;
}
...
{
    mp_add_decoder(list, "hwac3", "dts", "dts", "hwac3 dts");
    mp_add_decoder(list, "hwac3", "ac3", "ac3", "hwac3 ac3");
}
