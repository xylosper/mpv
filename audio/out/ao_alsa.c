...
static int find_alsa_format(int af_format)
{
    ...
    case AF_FORMAT_U24_LE:      return SND_PCM_FORMAT_U24_3LE;
    case AF_FORMAT_U24_BE:      return SND_PCM_FORMAT_U24_3BE;
    case AF_FORMAT_S24_LE:      return SND_PCM_FORMAT_S24_3LE;
    case AF_FORMAT_S24_BE:      return SND_PCM_FORMAT_S24_3BE;
    case AF_FORMAT_FLOAT_LE:    return SND_PCM_FORMAT_FLOAT_LE;
    case AF_FORMAT_FLOAT_BE:    return SND_PCM_FORMAT_FLOAT_BE;
    case AF_FORMAT_AC3_LE:      return SND_PCM_FORMAT_S16_LE;
    case AF_FORMAT_AC3_BE:      return SND_PCM_FORMAT_S16_BE;
    case AF_FORMAT_IEC61937_LE: return SND_PCM_FORMAT_S16_LE;
    case AF_FORMAT_IEC61937_BE: return SND_PCM_FORMAT_S16_BE;
...
static const char *find_device(struct mp_chmap *request)
{
    for (int n = 0; device_channel_layouts[n][0]; n++) {
        ...
        if (mp_chmap_set_equals(&map, request)) {
            *request = map;
...
static int init(struct ao *ao, char *params)
{
    ...
    err = snd_pcm_hw_params_test_format
            (p->alsa, alsa_hwparams, p->alsa_fmt);
    if (err < 0) {
